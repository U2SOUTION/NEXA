...
export async function handleFetchLayouts(req, res) {
  try {
...
export async function handleCreateArchive(req, res) {
...
export async function handleCreateArchiveDoc(req, res) {
...
export async function handleListArchives(req, res) {
  try {
...
export async function handleGetArchive(req, res) {
...
export async function handleUpdateArchive(req, res) {
  const id = Number(req.params.id)
  const { title, doc_type, status, layout_id } = req.body || {}
  if (!id || !title) {
...
export async function handleUpdateArchiveDoc(req, res) {
  const id = Number(req.params.id)
