...
export interface FullExtensionsOptions {
  inlineImage?: boolean
...
/**
 * full 스킨 — Tiptap 확장팩 구성 (base와 동일, 모든 툴 사용)
 * - 기능 이해·실험용으로 모든 Extension 장착
 */
export function createFullExtensions(options: FullExtensionsOptions = {}) {
...
export default createFullExtensions
