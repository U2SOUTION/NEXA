...
const leftSidebarConfigs = {
  'nexa-board': {
    component: () => import('src/domains/board/views/left/BoardLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  'parts-management': {
    component: () => import('src/domains/parts-management/views/left/PartsManagementLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  home: {
    component: () => import('src/frame/views/home/HomeLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  portfolio: {
    component: () => import('src/domains/portfolio/views/left/PortfolioLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  network: {
    component: () => import('src/domains/network/views/NetworkLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  solutions: {
    component: () => import('src/domains/solutions/views/SolutionsLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  extension: {
    component: () => import('src/domains/extension/views/ExtensionLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  help: {
    component: () => import('src/frame/views/help/HelpLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  my: {
    component: () => import('src/frame/views/my/MyLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  'nexa-pannel': {
    component: () => import('src/domains/panel/views/left/PanelLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  automation: {
    component: () => import('src/domains/node/views/left/NodeLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  erp: {
    component: () => import('src/domains/erp/views/left/ErpLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  infra: {
    component: () => import('src/domains/infra/views/left/InfraSidebar.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  'nexa-trace': {
    component: () => import('src/domains/trace/views/left/TraceLeftNav.vue'),
    preset: 'leftDefault',
    overrides: {},
  },
  dev: {
    component: () => import('src/domains/dev/views/DevLeftNav.vue'),
...
const rightSidebarConfigs = {
  // 넥사보드 전용 도구 패널
  'nexa-board': {
    component: () => import('src/domains/board/views/right/BoardRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
  // 넥사패널 전용 우측 패널
  'nexa-pannel': {
    component: () => import('src/domains/panel/views/right/PanelRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
  // 노드 전용 우측 패널
  automation: {
    component: () => import('src/domains/node/views/right/NodeRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
  // DEV 메뉴 전용 우측 패널 (Mermaid 스타일 편집 등)
  dev: {
    component: () => import('src/domains/dev/views/DevRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
  // INFRA 전용 우측 패널
  infra: {
    component: () => import('src/domains/infra/views/right/InfraRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
  // ERP 전용 우측 패널
  erp: {
    component: () => import('src/domains/erp/views/right/ErpRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
  // 부품관리 전용 우측 패널
  'parts-management': {
    component: () => import('src/domains/parts-management/views/right/PartsManagementRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
  // 기본 우측 사이드바 (등록되지 않은 메뉴용)
  default: {
    component: () => import('src/frame/views/common/DefaultRightPanel.vue'),
    preset: 'rightDefault',
    overrides: {},
  },
