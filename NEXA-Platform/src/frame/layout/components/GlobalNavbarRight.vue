<template>
  <div class="row items-center no-wrap">
    ...
    <div class="row items-center no-wrap header-icon-group">
      <q-btn flat dense 
        :icon="leftSidebarOpen ? 'left_panel_close' : 'left_panel_open'" 
        :label="showLabels ? '왼쪽 사이드바' : undefined" 
        class="text-primary" 
      ...
      <q-btn flat dense 
        :icon="rightSidebarOpen ? 'right_panel_close' : 'right_panel_open'" 
        :label="showLabels ? '사이드패널' : undefined" 
        class="text-primary" 
      ...
      <q-btn flat dense 
        ...
        :label="showLabels ? '테마전환' : undefined" 
        class="text-primary" 
