...
-->
<!--
  @tags: styles 카드, 통계 카드
  @category: cards
  @description: Stats Card 샘플 컴포넌트
-->
<template>
  <div class="stats-card-sample">
    <div class="sample-header">
      <h3 class="sample-title">통계 카드 샘플</h3>
      <p class="sample-description">통계 정보를 표시하는 카드 예시</p>
    </div>
