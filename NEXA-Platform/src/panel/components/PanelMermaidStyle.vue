...
import { useMermaidStyle } from 'src/modules/document-manager/composables/useMermaidStyle.js'
import { getDefaultMermaidCss, getMermaidStylePath } from 'src/modules/document-manager/services/mermaidStyleStorage.js'
...
<!-- 스타일은 src/css/nexa-system/_panel.scss에서 전역으로 관리됩니다 -->
