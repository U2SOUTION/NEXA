<template>
  <div class="nexia-editor-panel column">
...
/*
  ...
  - 참고: _scrollbar.scss 에서 .nexia-editor-panel 스크롤바 예외(8px) 적용.
*/
.nexia-editor-panel {
  height: 100%;
  flex: 1 1 0;
...
.nexia-editor-panel :deep(.tiptap-editor) {
  display: flex;
  flex-direction: column;
  min-width: 0;
  min-height: 100%;
...
.nexia-editor-panel :deep(.editor-scroll) {
  flex: 1 1 auto;
