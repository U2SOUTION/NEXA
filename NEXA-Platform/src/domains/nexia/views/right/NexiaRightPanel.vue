<template>
  <div class="nexia-right-panel column">
      ...
      <q-tab-panel name="agents" class="q-pa-none right-panel-inner">
        <div class="panel-scroll-area">
          <div class="nexia-panel-padding">
            <q-expansion-item v-for="item in NEXIA_AGENT_TABS" :key="item.id" :icon="item.icon" :label="item.label" :default-opened="item.id === 'skill'">
        ...
        <div class="panel-scroll-area">
          <div class="nexia-panel-padding">
            ...
            <q-expansion-item icon="terminal" label="INSTRUCTION" default-opened>
              <div class="instruction-section nexia-accordion-content">
            ...
            <q-expansion-item icon="chat" label="채팅" default-opened>
              <div class="chat-settings nexia-accordion-content">
...
import { NEXIA_AGENT_TABS } from '../../config/nexiaAgentTabRegistry'
import NexiaAgentSkillPanel from './agent/NexiaAgentSkillPanel.vue'
import NexiaAgentTaskPanel from './agent/NexiaAgentTaskPanel.vue'
import NexiaAgentWorkcardPanel from './agent/NexiaAgentWorkcardPanel.vue'
import { nexiaApi } from '../../services/nexiaApi'
import { useNexiaSettings } from '../../composables/useNexiaSettings'
import { useNexiaChannels } from '../../composables/useNexiaChannels'
import { useNexiaModels } from '../../composables/useNexiaModels'

const { selectedModel, chatMode, chatInputMaxRows, chatFontSize, chatMessageMaxLength, titleSuggestionMinTurns, titleSuggestionMaxTurnsForContext, modelCapabilities, outlineEnabled, outlineDisplayMode, outlinePanelWidth } = useNexiaSettings()
const { models, isLoadingModels, loadModels } = useNexiaModels()
...
const { selectedChannel, selectedChat, selectedChannelId, systemInstruction, updateSystemInstruction, updateChannelInstruction, updateChatInstruction } = useNexiaChannels()
...
const agentPanels = {
  skill: NexiaAgentSkillPanel,
  task: NexiaAgentTaskPanel,
  workcard: NexiaAgentWorkcardPanel,
}
...
async function checkConnection() {
  ...
  try {
    await nexiaApi.checkConnection(ollamaBaseUrl.value)
