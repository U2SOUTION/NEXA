/**
 * useNexiaLeftToolbar - AI 왼쪽 패널 툴바·검색 폼 설정
...
export interface NexiaLeftToolbarCtx {
...
export function useNexiaLeftToolbar(ctx: NexiaLeftToolbarCtx) {
...
function getProjectItems(ctx: NexiaLeftToolbarCtx): ToolbarItem[] {
...
function getChatItems(ctx: NexiaLeftToolbarCtx): ToolbarItem[] {
  const items: ToolbarItem[] = []
  items.push({
    id: 'add',
    type: 'menu',
...
function getNoteItems(ctx: NexiaLeftToolbarCtx): ToolbarItem[] {
  return [
...
function getMediaItems(ctx: NexiaLeftToolbarCtx): ToolbarItem[] {
  return [
