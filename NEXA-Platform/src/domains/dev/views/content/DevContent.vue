...
import DocumentManagerContent from '@domains/dev/views/dev-tools/document-manager/DocumentManagerContent.vue'
import ThemeManagerContent from '@domains/dev/views/dev-tools/theme-manager/ThemeManagerContent.vue'
import GraphDocContent from '@domains/dev/views/dev-tools/graph-doc/GraphDocContent.vue'
import PerformanceMonitorContent from '@domains/dev/views/dev-tools/performance-monitor/PerformanceMonitorContent.vue'
import DatabaseViewerContent from '@domains/dev/views/dev-tools/database-viewer/DatabaseViewerContent.vue'
import SettingsManagerContent from '@domains/dev/views/dev-tools/settings-manager/SettingsManagerContent.vue'
import ComponentLibraryContent from '@domains/dev/views/dev-tools/component-library/ComponentLibraryContent.vue'
import DevGuideContent from '@domains/dev/views/dev-tools/dev-guide/DevGuideContent.vue'
import DevOpsContent from '@domains/dev/views/dev-tools/devops/DevOpsContent.vue'
