...
const { activeMenu, setActiveMenu } = useDevMenuState()
...
const devMenus = [
  ...
  // 최우선: 핵심 관리 도구
  { id: 'dev-guide', label: '개발 가이드', icon: 'menu_book' },
...
const initialActiveDotIndex = activeMenu.value ? devMenus.findIndex((menu) => menu.id === activeMenu.value) : 0
