...
import { loadTOCSettings, saveTOCSettings } from '@domains/dev/modules/document-manager/services/documentStorage.js'
...
import { useDocumentSearch } from '@domains/dev/modules/document-manager/composables/useDocumentSearch.js'
