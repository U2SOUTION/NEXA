...
import { loadTOCSettings, saveTOCSettings } from '@domains/dev/modules/document-manager/services/documentStorage'
import { useDocumentMultiSelection } from '@system/composables/useDocumentMultiSelection'
import { useDocumentManagerStore } from '@system/store/documentManagerStore'
import { useDocumentSearch } from '@domains/dev/modules/document-manager/composables/useDocumentSearch'
import { useComponentLibrary } from '@system/composables/useComponentLibrary'
import { useDatabaseViewer } from '@system/composables/useDatabaseViewer'
import { useThemeManager } from '@system/composables/useThemeManager'
import { useDocumentFilters } from '@system/composables/useDocumentFilters'
import { useErrorTracking } from '@system/composables/useErrorTracking'
import { useDevGuide } from '@system/composables/useDevGuide'
import { useSettingsManager } from '@system/composables/useSettingsManager'
...
// 메뉴 상태 관리 (composable 사용)
const { activeMenu, setActiveMenu, initialize: initializeMenuState } = useDevMenuState()
...
const menuHeaders = {
  ...
  'component-library': { title: 'Component Library', subtitle: 'Component library and classification' },
...
onMounted(() => {
  ...
  // 호환성을 위해 유지 (다른 컴포넌트에서 이벤트를 보낼 수 있음)
