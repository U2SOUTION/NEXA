...
<template>
  <div class="nexage-tools-panel column no-wrap">
    ...
    <div class="panel-scroll col">
      ...
      <div class="accordion-wrapper">
        <q-expansion-item icon="devices_other" label="디바이스">
          <device-section />
        </q-expansion-item>
      </div>
      <div class="accordion-wrapper">
        <q-expansion-item icon="history" label="히스토리">
          <history-section />
        </q-expansion-item>
      </div>
      <div class="accordion-wrapper">
        <q-expansion-item icon="notifications" label="알림">
 ...
 * --------------------------------
 * 1. 배경색
 *    - q-drawer의 배경색을 자동으로 상속받음
 *    - 별도의 배경색 지정 불필요
 *
 * 2. 아코디언 스타일
 *    - 전역 스타일(_expansion-item.scss)에 의존
 *    - 컴포넌트별 커스텀 스타일은 최소화
 */
.nexage-tools-panel {
  height: 100%;
