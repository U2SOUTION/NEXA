<template>
  <div class="preset-setup-view">
    ...
    <WindowPresetSelector mode="setup" selection-mode="confirm" @select="handleSelect" />
  </div>
</template>

<script setup>
import WindowPresetSelector from '@domains/nexage/components/window/WindowPresetSelector.vue'
