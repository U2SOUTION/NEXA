...
import WindowPresetSetupView from '@domains/nexage/components/window/WindowPresetSetupView.vue'
import DeviceConnectionView from '@domains/nexage/components/device/DeviceConnectionView.vue'
