...
function getUsageLocations(keyName) {
  ...
  if (actualSelectedSetting.value && actualSelectedSetting.value.type === 'config-file') {
    ...
    if (configFileName.includes('devGuide')) {
      ...
      locations.push({
        path: 'src/components/dev-tools/component-library/ComponentLibraryContent.vue',
        type: 'component',
      ...
      locations.push({
        path: 'src/components/parts-management/PartClassesView.vue',
        type: 'component',
        description: '부품 클래스 뷰에서 사용',
      })
      locations.push({
        path: 'src/components/parts-management/ViewModeSelector.vue',
        type: 'component',
  ...
  if (keyName.startsWith('dev-guide-')) {
    ...
    if (keyName.includes('sort-mode')) {
      ...
      locations.push({
        path: 'src/components/dev-tools/dev-guide/DevGuideContent.vue',
        type: 'component',
  ...
  if (keyName.startsWith('Error-') || keyName.startsWith('error-')) {
    ...
    locations.push({
      path: 'src/components/dev-tools/error-tracking/ErrorTrackingContent.vue',
      type: 'component',
