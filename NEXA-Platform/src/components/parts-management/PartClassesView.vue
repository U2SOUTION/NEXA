...
import AddEditPartClassModal from 'src/components/parts-management/item-action-modules/modals/AddEditPartClassModal.vue'
import DataPageNavigation from 'src/components/ui/DataPageNavigation.vue'
import PrintModal from 'src/components/parts-management/PrintModal.vue'
...
import DeleteModal from 'src/components/parts-management/item-action-modules/modals/DeleteModal.vue'
import ActivateStatusModal from 'src/components/parts-management/item-action-modules/modals/ActivateStatusModal.vue'
import FavoriteModal from 'src/components/parts-management/item-action-modules/modals/FavoriteModal.vue'
import HistoryModal from 'src/components/parts-management/item-action-modules/modals/HistoryModal.vue'
import RelatedPartsModal from 'src/components/parts-management/item-action-modules/modals/RelatedPartsModal.vue'
import ReorderModal from 'src/components/parts-management/item-action-modules/modals/ReorderModal.vue'
import DetailModal from 'src/components/parts-management/item-action-modules/modals/DetailModal.vue'
import ExportModal from 'src/components/parts-management/item-action-modules/modals/ExportModal.vue'
import ShareUrlModal from 'src/components/parts-management/item-action-modules/modals/ShareUrlModal.vue'
import ViewModeSettingsModal from 'src/components/parts-management/item-action-modules/modals/ViewModeSettingsModal.vue'
import DataTableRenderer from 'src/renderers/DataTableRenderer.vue'
import DataCardRenderer from 'src/renderers/DataCardRenderer.vue'
import DataListRenderer from 'src/renderers/DataListRenderer.vue'
...
import { getRowNumber, formatDateTime } from 'src/utils/dataViewUtils'
import { loadViewModeSettings, saveViewModeSettings, VIEW_MODES, defaultTableViewSettings, defaultCardViewSettings, defaultListViewSettings, defaultChartViewSettings } from 'src/components/parts-management/config/viewModeSettings'
import { useTableFilter } from 'src/composables/useTableFilter'
import { usePaginationControl } from 'src/composables/usePaginationControl'
import { useTableKeyboard } from 'src/composables/useTableKeyboard'
import { useMultiSelection } from 'src/composables/useMultiSelection'
import { useTableDragDrop } from 'src/composables/useTableDragDrop'
import { useTableDuplicate } from 'src/composables/useTableDuplicate'
import { useSidebarNavigation } from 'src/composables/useSidebarNavigation'
import { useURLStateManagement } from 'src/composables/url-state'
import { useModalManager } from 'src/composables/useModalManager'
import { useDynamicLabel } from 'src/composables/useDynamicLabel'
import ContextMenu from 'src/components/ui/ContextMenu.vue'
import TableFilterBar from 'src/components/ui/TableFilterBar.vue'
import TableEmptyState from 'src/components/ui/TableEmptyState.vue'
import TableActionsOverlay from 'src/components/ui/TableActionsOverlay.vue'
...
import { exportData as exportDataUtil } from 'src/utils/export'
...
async function handlePrintConfirm({ options, columns, formatting, type, onWindowOpen }) {
  try {
    ...
    // 인쇄 실행
    const { printData } = await import('src/utils/print/index.js')
    printData({
      data: dataToProcess,
