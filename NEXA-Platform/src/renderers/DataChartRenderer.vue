...
import Chart from 'src/charts/NexaChart.vue'
import MultiChartContainer from 'src/charts/MultiChartContainer.vue'
import { getChartMetadata } from 'src/charts/config/chartMetadata.js'
...
<!-- 툴팁 스타일은 전역 CSS로 이동됨 (src/css/nexa-system/_chart.scss) -->
