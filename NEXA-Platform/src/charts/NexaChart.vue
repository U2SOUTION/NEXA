...
-->
<template>
  <div ref="chartContainerRef" class="chart-wrapper" :style="{ width: width + 'px', height: height + 'px' }">
...
// 데이터 변경 시 재렌더링
watch(
  () => [props.data, props.type, props.width, props.height, props.options, props.style],
  () => {
