...
**참조**: 기술 스택·프로토콜·라이브러리 용어는 **[NEXA-STACK-01]** 기술_스택_통합_가이드_및_용어_정리를 참조한다.
...
- **가중치·GOVERN 반영**: 현재 프로젝트에 선택된 **도메인별·성격별 가중치 밸런스 템플릿** 또는 **사용자 정의 가중치 세트**를 읽어, RAG 필터·인디케이터·실행 흐름에 반영한다. (참조: [문서 3] 6개 코일 밸런스 §5.4·§5.5)
...
- **[NEXA-STACK-01]** 기술_스택_통합_가이드_및_용어_정리 — 기술 스택, gRPC, Temporal, Redis 등
- **[NEXA-CAPABILITY-01]** Capability_ID_체계_및_Tier_접근_권한 — 권한·Capability 검사
