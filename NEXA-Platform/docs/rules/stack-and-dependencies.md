...
**온라인 미니 닉시(격자 HUD):** 연출·GSAP·임시 컨트롤 상세는 `docs/Nexion/[NXN] [SPEC] 심플 닉시 GSAP 적용 UI 구현 v0.1.md`. N-MAP·Pinia 계약은 `[NXN] [SPEC] 심플 닉시(Simple NIXIE) 테스트 버전 구현 v0.1.md`. **도트·정보 연출은 GSAP(Timeline)** 를 1차로 두며, **Rive**는 해당 HUD에서 필수 아님.
