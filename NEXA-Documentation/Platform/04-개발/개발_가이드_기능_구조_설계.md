...
**위치**: `NEXA-Platform/src/domains/dev/modules/dev-guide/services/sampleRegistry.js`
...
**위치**: `NEXA-Platform/src/domains/dev/modules/dev-guide/services/sampleManager.js`
...
**위치**: `NEXA-Platform/src/domains/dev/modules/dev-guide/services/tagManager.js`
...
**위치**: `NEXA-Platform/src/domains/dev/modules/dev-guide/services/sampleStorage.js`
...
-   **메타데이터**: `src/domains/dev/modules/dev-guide/services/sampleRegistry.js`에 중앙 관리
...
```javascript
// 샘플 추가
import { sampleRegistry } from "src/domains/dev/modules/dev-guide/services/sampleRegistry.js";
...
```javascript
import { searchSamples, filterSamples, sortSamples } from "src/domains/dev/modules/dev-guide/services/sampleManager.js";
...
```javascript
import { addTagToSample, removeTagFromSample, getTagSuggestions } from "src/domains/dev/modules/dev-guide/services/tagManager.js";
...
```javascript
import { addRecentSample, toggleFavoriteSample, updateSampleUsage } from "src/domains/dev/modules/dev-guide/services/sampleStorage.js";
...
1. **태그 추가**:
    ...
    ```javascript
    import { addTagToSample } from "src/domains/dev/modules/dev-guide/services/tagManager.js";
...
2. **태그 제거**:
    ...
    ```javascript
    import { removeTagFromSample } from "src/domains/dev/modules/dev-guide/services/tagManager.js";
...
3. **태그 자동완성**:
    ...
    ```javascript
    import { getTagSuggestions } from "src/domains/dev/modules/dev-guide/services/tagManager.js";
...
-   [ ] `src/domains/dev/modules/dev-guide/services/` 디렉토리 생성
...
```javascript
// src/domains/dev/modules/dev-guide/services/sampleRegistry.js
export const sampleRegistry = [
    {
        id: "nexa-chart-bar",
        name: "넥사차트-막대그래프",
...
-   [ ] `NEXA-Platform/src/domains/dev/modules/dev-guide/services/sampleRegistry.js` (핵심 데이터)
-   [ ] `NEXA-Platform/src/domains/dev/modules/dev-guide/services/sampleManager.js` (검색, 필터, 정렬)
-   [ ] `NEXA-Platform/src/domains/dev/modules/dev-guide/services/tagManager.js` (태그 관리)
-   [ ] `NEXA-Platform/src/domains/dev/modules/dev-guide/services/sampleStorage.js` (localStorage 관리)
